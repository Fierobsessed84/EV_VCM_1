void setup_file_time_and_logs()
{
  ...
  {
    printNow();                                  // time stamp
    file.print(",Accel/Regen,APS1,APS2,Normalized APS1,Normalized APS2,APS1 HIGH,APS1 LOW,APS2 HIGH,APS2 LOW,APS1 HIGH LIM,APS1 LOW LIM,APS2 HIGH LIM,APS2 LOW lIM,DU APS (POT)"); // create CSV header first half
